...
import { VatReportQueryDto, VatReportPeriod, VatReportResponseDto } from './dto/vat-report.dto';
...
export class ReportsController {
  ...
  @ApiOperation({
    ...
    description: 'Generate a VAT report for the specified period. businessId required as query param.',
  })
  @ApiOkResponse({ description: 'VAT report generated', type: VatReportResponseDto })
