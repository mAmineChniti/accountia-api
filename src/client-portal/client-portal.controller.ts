...
import {
  ...
  GeneratePortalTokenResponseDto,
...
export class ClientPortalController {
  ...
  @ApiOkResponse({ type: GeneratePortalTokenResponseDto })
  async generateToken(
  ...
  @ApiOkResponse({ description: 'Portal info retrieved' })
  ...
  @ApiParam({ name: 'token', type: String })
  @ApiOkResponse({ description: 'Client invoices retrieved' })
