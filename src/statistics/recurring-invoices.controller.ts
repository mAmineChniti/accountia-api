...
export class RecurringInvoicesController {
  ...
  @ApiResponse({
    status: 201,
    description: 'The recurring invoice has been successfully created.',
  })
  create(
  ...
  @ApiResponse({ status: 200, description: 'List of recurring invoices' })
  findAll() {
  ...
  @ApiOperation({
    summary:
      'Get overall statistics for recurring invoices (MRR, Active, Paused)',
  })
  @ApiResponse({ status: 200, description: 'Recurring invoice statistics' })
  getStats() {
  ...
  @ApiResponse({ status: 200, description: 'The recurring invoice details' })
  ...
  @ApiOperation({
    summary:
      'Update the status of a recurring invoice (active/paused/cancelled)',
  })
  @ApiResponse({ status: 200, description: 'Status updated successfully' })
  updateStatus(
    @Param('id') id: string,
    @Body() statusDto: UpdateRecurringInvoiceStatusDto
  ) {
