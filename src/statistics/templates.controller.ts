  ...
  async onModuleInit() {
    ...
    if (count === 0) {
      await this.templateModel.insertMany([
        { name: 'Standard Professional', key: 'standard', description: 'Clean and widely accepted format' },
        { name: 'Modern Minimal', key: 'modern', description: 'Contemporary and minimalist design' },
        { name: 'Executive Blue', key: 'executive', description: 'Formal design with deep blue accents' },
      ]);
